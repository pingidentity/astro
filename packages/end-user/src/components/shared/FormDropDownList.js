...
import { default as FormTextFieldStateless } from '../TextInput';
...
const FormDropDownList = inStateContainer([
    {
        name: "open",
        initial: false,
        callbacks: [{
...
FormDropDownList.displayName = "FormDropDownList";
...
FormDropDownList.searchTypes = SearchTypes; // we agreed on a new naming standard, but I'm also preserving bw compat
FormDropDownList.filterOptions = filterOptions;
FormDropDownList._statelessComponent = FormDropDownListStateless;
