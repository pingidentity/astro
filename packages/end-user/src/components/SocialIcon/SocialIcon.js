...
const SocialIcons = {
    ...
    INSTAGRAM: ({ width = '100%', height = '100%' }) => {
        return (
            <svg x="0px" y="0px" viewBox="0 0 100 100" style={{ enableBackground: `new 0 0 ${width} ${height}`, width, height }}>
            <rect id="Rectangle" stroke="#E33E5C" stroke-width="5" fill="#E33E5C" x="0" y="0" width="100" height="100" rx="3"></rect>
                <g>
                    <path
                        style={{ fill: '#FFFFFF' }}
    ...
    GITHUB: ({ width = '100%', height = '100%' }) => {
        return (
            ...
            <rect style={{ fill: "#000", stroke: "#000", strokeMiterlimit: 10 }} width="315" height="310" />
                <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
