...
import Card, { CardMessage, messageTypes } from '../components/Card';
...
<ComponentDemo>
    <Card>
        <Logo src="ping-logo.svg"/>
        <IconFeedback type="error">Trial Expired</IconFeedback>
        <TextBlock spacing="xxlarge" size="large">To extend your trial, please contact us.</TextBlock>
