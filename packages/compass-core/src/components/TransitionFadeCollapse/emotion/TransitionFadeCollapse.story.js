...
import TransitionFadeCollapse from './TransitionFadeCollapse';
import Button from '../../Button';

export default {
    title: 'Transitions/TransitionFadeCollapse',
    component: TransitionFadeCollapse,
...
export const Default = () => {
    ...
    return (
        <>
            ...
            <TransitionFadeCollapse interval={500} isShowing={isOpen}>
