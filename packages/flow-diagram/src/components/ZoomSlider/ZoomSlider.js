    ...
    */
    ...
    var ZoomSlider = /** @class */ (function () {
        ...
        ZoomSlider.prototype.sliderDivSetup = function () {
            ...
            this._sliderDiv.style.zIndex = '99';
            this._sliderDiv.style.display = 'flex';
            this._sliderDiv.style.alignItems = 'center';
            // Initialize buttons and range input
            var zoomText = document.createElement('div');
            zoomText.style.fontSize = '13px';
            zoomText.style.margin = '7px 15px 0px 0px';
            zoomText.style.width = '40px';
            zoomText.style.color = '#68747F';
            zoomText.style.fontFamily = 'Helvetica Neue, Helvetica, Arial';
            zoomText.style.fontWeight = '500';
            ...
            zoomDivider.style.borderRight = '1px solid #68747F';
            zoomDivider.style.margin = '4px 6px 0px 6px';
            zoomDivider.style.height = '25px';
            zoomText.id = 'zoomText';
            ...
            zoomRangeContainer.style.display = 'none';
        ...
        ZoomSlider.prototype.sliderListenerSetup = function () {
            ...
            var zoomToFit = document.getElementById('zoomToFit')
        ...
        ZoomSlider.prototype.realign = function () {
            ...
            if (diagramParent !== null) {
                ...
                // this._sliderDiv.style.top = top_1 + 10 + 'px';
                // this._sliderDiv.style.left = left - 20 + 'px';
                this._sliderDiv.style.top = '2%';
                this._sliderDiv.style.right = '1%';
            }
        };
        /**
         * @ignore
        ...
        ZoomSlider.prototype.scaleToValue = function () {
            ...
            var sliderText = document.getElementById('zoomText');
