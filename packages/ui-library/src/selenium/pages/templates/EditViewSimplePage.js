...
var EditViewSimpleDemoPage = Object.create(HomePage, {
     ...
     * @param {string} valueOption - the value for select box
     */
    ...
    clickUserGroup: {
        value: function (index) {
            var xPath = "//label[@data-id='radio-btn_label_{index}']";
    ...
    clickCheckboxActiveUser: {
        value: function () {
            this.click("//label[@data-id='userActive-container']");
        }
    },
    ...
    /**
     * @desc this function is to open template Edit View Simple
     */
...
module.exports = EditViewSimpleDemoPage;
