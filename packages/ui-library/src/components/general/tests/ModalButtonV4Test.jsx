...
describe("ModalButtonTest v4", function () {
    ...
    function getComponentWithoutDefaults (opts) {
        return ReactTestUtils.renderIntoDocument(<ModalButton {...opts} flags={allFlags} />);
    }
    ...
    it("Doesn't render body until expanded", function () {
        ...
        ReactTestUtils.findRenderedComponentWithType(component, StateContainer).callbacks.onOpen();
    ...
    it("Open/close stateless modal button", function () {
        ...
        expect(ReactTestUtils.findRenderedComponentWithType(component, ModalButton._statelessComponent)).toBeDefined();
    });
