    ...
    render: function () {
        return (
            this.props.controlled
                ? <ToggleStateless ref="ToggleStateless" {...this.props} />
                : <ToggleStateful ref="ToggleStateful" {...this.props} />
        );
    }
});
...
var ToggleStateful = React.createClass({
    ...
    render: function () {
        return (
            <ToggleStateless ref="ToggleStateless" {...this.props} toggled={this.state.toggled}
