...
module.exports = {
     ...
     * @desc Validate that a phone number has only empty, numbers, parens, dashes & whitespace
             (e.g.: (604) 555-1337)
     * @param {string} str string to validate
     * @return {boolean} true if only empty, numbers, parens, dashes & whitespace present
     */
