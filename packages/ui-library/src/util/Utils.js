...
var Utils = {
     ...
     */
    diffProps: function (current, next, list) {
     ...
     */
    deprecateWarn: function (feature, useInstead, log) {
        var warning = [
    ...
    */
    ...
    browserVersion: function () {
        ...
        if (this.browserType() === browsers.SAFARI) {
        ...
        if ( this.browserType() === browsers.EDGE) {
     ...
     */
    isIE: function () {
        return this.browserType() === browsers.IE || this.browserType() === browsers.EDGE ;
    },
     ...
     */
    isFirefox: function () {
        return this.browserType() === browsers.FIREFOX;
    },
     ...
     */
    isChrome: function () {
        return this.browserType() === browsers.CHROME;
    },
     ...
     */
    isSafari: function () {
        return this.browserType() === browsers.SAFARI;
    },
     ...
     */
    isIE9: function () {
        return (this.browserType() === browsers.IE) && (this.browserVersion() <= 9) ;
    },
