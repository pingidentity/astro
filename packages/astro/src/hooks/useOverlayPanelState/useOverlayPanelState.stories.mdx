...
import useOverlayPanelState, { DummyComponent } from '../useOverlayPanelState';

<Meta title="Hooks/useOverlayPanelState" />
...
See the <LinkTo kind="OverlayPanel" story="Default">Overlay Panel docs</LinkTo> for an example of how to 
implement this hook.
