...
import { placement, stylePropKeys } from '../../utils/devUtils/styledSystemUtils';
import useAstroTheme from '../../styles/useAstroTheme';
...
const Box = ({ isRow, ...props }) => {
  ...
  return (
    <div
      ...
      `}
      {...omit(_.omit(props, stylePropKeys))}
    />
  );
};
