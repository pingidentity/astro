...
If the Callout status is an error or warning, the text should include a direct link to instructions on resolving the issue or error.
...
Callout and Icon utilize `aria-label` to give an accessible name to the components.
