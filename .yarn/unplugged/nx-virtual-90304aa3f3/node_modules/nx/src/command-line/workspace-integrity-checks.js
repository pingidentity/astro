...
class WorkspaceIntegrityChecks {
    ...
    misalignedPackages() {
        var _a, _b, _c;
        const bodyLines = [];
        const packageJson = (0, fileutils_1.readJsonFile)((0, path_1.joinPathFragments)(workspace_root_1.workspaceRoot, 'package.json'));
        ...
        for (const pkg of this.nxPackageJson['nx-migrations'].packageGroup) {
            ...
            if (typeof pkg === 'string' || pkg.version === '*') {
                // should be aligned
                const installedVersion = (_b = (_a = packageJson.dependencies) === null || _a === void 0 ? void 0 : _a[packageName]) !== null && _b !== void 0 ? _b : (_c = packageJson.devDependencies) === null || _c === void 0 ? void 0 : _c[packageName];
                if (installedVersion &&
