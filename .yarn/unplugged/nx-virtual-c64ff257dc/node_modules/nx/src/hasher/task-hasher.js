...
exports.filterUsingGlobPatterns = exports.expandNamedInput = exports.splitInputsIntoSelfAndDependencies = exports.extractPatternsFromFileSets = exports.getTargetInputs = exports.getNamedInputs = exports.InProcessTaskHasher = exports.DaemonBasedTaskHasher = void 0;
...
class DaemonBasedTaskHasher {
    ...
    hashTask(task) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return (yield this.daemonClient.hashTasks(this.runnerOptions, [task]))[0];
        });
    }
}
...
class InProcessTaskHasher {
    ...
    hashTask(task) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return {
                value: (0, impl_1.hashArray)([res.value, command]),
                details: {
                    command,
                    nodes: res.details,
                    implicitDeps: {},
...
class TaskHasherImpl {
    ...
    hashTask(task, visited) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return Promise.resolve().then(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                if (target) {
                    return {
                        value: (0, impl_1.hashArray)([selfAndInputs.value, target.value]),
    ...
    hashSelfAndDepsInputs(projectName, selfInputs, depsInputs, projectInputs, visited) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const value = (0, impl_1.hashArray)([
                ...self.map((d) => d.value),
                ...deps.map((d) => d.value),
    ...
    hashTarget(projectName, targetName, selfInputs) {
        ...
        if (target.executor.startsWith(`@nrwl/`) ||
            ...
            if (hasCommandExternalDependencies) {
                hash = (0, impl_1.hashArray)(partialHashes);
            }
            else {
                ...
                if (this.externalDepsHashCache['']) {
                    ...
                    hash = (0, impl_1.hashArray)([JSON.stringify(this.projectGraph.externalNodes)]);
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!this.filesetHashes[mapKey]) {
                this.filesetHashes[mapKey] = new Promise((res) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    const value = (0, impl_1.hashArray)(parts);
                    res({
                        value,
    ...
    hashEnv(envVarName) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const value = (0, impl_1.hashArray)([(_a = process.env[envVarName]) !== null && _a !== void 0 ? _a : '']);
            return {
