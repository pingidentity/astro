...
function invokeTasksRunner({ tasks, projectGraph, taskGraph, lifeCycle, nxJson, nxArgs, loadDotEnvFiles, initiatingProject, }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (client_1.daemonClient.enabled()) {
            ...
            hasher = new task_hasher_1.InProcessTaskHasher(projectFileMap, allWorkspaceFiles, projectGraph, nxJson, runnerOptions, impl_1.fileHasher);
        }
        // this is used for two reasons: to fetch all remote cache hits AND
        // to submit everything that is known in advance to Nx Cloud to run in
        // a distributed fashion
        perf_hooks_1.performance.mark('hashing:start');
        yield (0, hash_task_1.hashTasksThatDoNotDependOnOtherTasks)(new workspaces_1.Workspaces(workspace_root_1.workspaceRoot), hasher, projectGraph, taskGraph);
