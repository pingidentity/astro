...
function computeWorkspaceConfigHash(projectsConfigurations) {
    return (0, impl_1.hashArray)([JSON.stringify(projectsConfigurations)]);
}
/**
...
function processCollectedUpdatedAndDeletedFiles() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const updatedFiles = yield impl_1.fileHasher.hashFiles(filterUpdatedFiles([...collectedUpdatedFiles.values()]));
            ...
            impl_1.fileHasher.incrementalUpdate(updatedFiles, deletedFiles);
            ...
            if (workspaceConfigHash !== storedWorkspaceConfigHash) {
                ...
                exports.projectFileMapWithFiles = (0, file_map_utils_1.createProjectFileMap)(projectsConfiguration, impl_1.fileHasher.allFileData());
            }
            else {
                exports.projectFileMapWithFiles = exports.projectFileMapWithFiles
                    ...
                    : (0, file_map_utils_1.createProjectFileMap)(projectsConfiguration, impl_1.fileHasher.allFileData());
            }
