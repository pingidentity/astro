...
export const Default = ({ ...args }) => {
  ...
  const ShieldIcon = props => {
    ...
    return (
      <svg width="19" height="23" viewBox="0 0 19 23" xmlns="http://www.w3.org/2000/svg" aria-labelledby={`shield-icon-title-${id}`} {...props}>
        <title id={`shield-icon-title-${id}`}>Shield Icon</title>
