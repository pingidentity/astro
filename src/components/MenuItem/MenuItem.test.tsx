...
describe('MenuItem', () => {
  ...
  test('hovering menuItems applies hover class and removes hover style on unhover with "isNotFocusedOnHover"', async () => {
  ...
  test('hovering menuItems applies hover class and leaves hover style on unhover', async () => {
    getComponent();
...
describe('MenuItem', () => {
  ...
  test('checkmark icon is shown when item is selected and theme is onyx', () => {
    getComponent({
      selectionMode: 'single',
      defaultSelectedKeys: [defaultMenuItems[0].key],
    });
