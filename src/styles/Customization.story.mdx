...
The Astro component library ships with [a default theme](/?path=/story/astro-theme--page) based on Ping's 
...
Components typically use a custom variant to apply styles. See the [Astro Theme](/?path=/story/astro-theme--page) documentation for more information on this. To override these styles, 
