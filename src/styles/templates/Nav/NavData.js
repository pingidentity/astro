...
const data = [
  {
    ...
    children: [
      <NavBarItemButton
        key="Authentication Dashboard"
        id="Authentication Dashboard"
      >
        Authentication
      </NavBarItemButton>,
      <NavBarItemButton key="MFA Dashboard" id="MFA Dashboard">
        MFA
      </NavBarItemButton>,
      <NavBarItemButton key="Risk Dashboard" id="Risk Dashboard">
        Risk
      </NavBarItemButton>,
    ],
  },
  {
    ...
    heading: 'Identities',
    children: [
      <NavBarItemButton key="Identities Link Users" id="Identities Link Users">
        Users
      </NavBarItemButton>,
      <NavBarItemButton
      ...
      <NavBarItemButton key="Identities Link Roles" id="Identities Link Roles">
        Roles
      </NavBarItemButton>,
    ],
  },
  {
    ...
    heading: 'Connections',
    children: [
      <NavBarItemButton key="Connection Link Users" id="Connection Link Users">
        Users
      </NavBarItemButton>,
      <NavBarItemButton
...
const secondData = [
  {
    ...
    heading: 'MFA',
    children: [
      <NavBarItemButton id="MFA Button Users" key="MFA Button Users">
        Users
      </NavBarItemButton>,
      {
        isSubTitle: true,
      ...
      <NavBarItemButton key="MFA Button Group" id="MFA Button Group">
        Group Test
      </NavBarItemButton>,
    ],
  },
  {
    ...
    heading: 'Risk',
    children: [
      <NavBarItemButton key="Risk Button Users" id="Risk Button Users">
        Users
      </NavBarItemButton>,
      {
        isSubTitle: true,
      ...
      <NavBarItemButton key="Risk Button Group" id="Risk Button Group">
        Group
      </NavBarItemButton>,
    ],
  },
  {
    ...
    heading: 'Verify',
    children: [
      <NavBarItemButton key="Verify Button Users" id="Verify Button Users">
        Users
      </NavBarItemButton>,
      {
        isSubTitle: true,
      ...
      <NavBarItemButton key="Verify Button Group" id="Verify Button Group">
        Group
      </NavBarItemButton>,
    ],
  },
...
const thirdData = [
  {
    ...
    heading: 'Environment',
    children: [
      <NavBarItemButton key="Earth Button Users" id="Earth Button Users">
        Users
      </NavBarItemButton>,
      <NavBarItemButton key="Earth Button Group" id="Earth Button Group">
        Group
      </NavBarItemButton>,
    ],
  },
